...
public class SamuraiShiftAccessibilityService extends AccessibilityService {
    ...
    public void onAccessibilityEvent(AccessibilityEvent event) {
        ...
        Log.d(TAG, "Event Type: " + event.getEventType() + ", Package Name: " + event.getPackageName());
        ...
        if (!buttons.isEmpty()) {
            for (AccessibilityNodeInfo button : buttons) {
                if (button.isClickable()) {
                    ...
                    Log.d(TAG, "Clicked 'Book Shift' button");
    ...
    protected void onServiceConnected() {
        ...
        setServiceInfo(info);
        Log.d(TAG, "Samurai Shift Accessibility Service Connected");
        Toast.makeText(this, "Samurai Shift Accessibility Service Connected", Toast.LENGTH_LONG).show();
    }

    @Override
    public boolean onUnbind(Intent intent) {
        Log.d(TAG, "Samurai Shift Accessibility Service Unbound");
